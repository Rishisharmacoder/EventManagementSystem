...
import { motion } from 'framer-motion'; // Check if your import is 'motion/react' or 'framer-motion'
...
export default function Home() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      ...
      try {
        const { data } = await api.get(`/events/all?page=${page}&limit=6`);
  ...
  return (
    <div className="space-y-24 pb-24 bg-white min-h-screen">
      ...
      <motion.section 
        ...
        className="relative h-[600px] rounded-[3rem] overflow-hidden group shadow-2xl mx-4 mt-4"
      >
        <img 
        ...
        <div className="absolute inset-0 flex items-center px-8 md:px-20">
          <div className="max-w-3xl text-white space-y-8">
            ...
            >
              ...
              EVENT MANAGEMENT SYSTERM
            </motion.div>
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter text-white">
              Ignite Your <br/>
            ...
            <div className="flex flex-wrap gap-5 pt-6">
              <Link to="/events" className="btn btn-secondary btn-lg rounded-2xl px-12 text-white shadow-2xl shadow-secondary/30 hover:shadow-secondary/50 transition-all active:scale-95 font-bold">Explore Events</Link>
              <Link to="/about" className="btn btn-ghost btn-lg rounded-2xl px-12 text-white border-2 border-white/20 hover:bg-white/10 backdrop-blur-sm transition-all active:scale-95 font-bold">Learn More</Link>
            </div>
          </div>
        </div>
      </motion.section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        {[
          ...
          <motion.div 
            ...
            className="bfgi-card p-10 text-center group relative overflow-hidden bg-white border border-slate-100 shadow-sm"
          >
      ...
      <section className="space-y-12 px-4">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl font-black text-slate-900">Upcoming Campus Events</h2>
            <p className="text-slate-600 font-medium max-w-2xl">Stay updated with the latest technical, cultural, and academic events happening across the campus.</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {events.map((event, index) => (
                <motion.div
                  ...
                  className="bfgi-card group overflow-hidden flex flex-col bg-white border border-slate-100"
                >
                  <div className="relative h-64 overflow-hidden">
                    <img 
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute top-6 left-6 glass-panel rounded-2xl p-3 text-center min-w-[70px] bg-white/80 backdrop-blur-sm">
                  ...
                  <div className="p-8 space-y-6 flex-1 flex flex-col">
                    ...
                    <div className="pt-4 mt-auto">
                      <Link to={`/events/${event._id}`} className="btn btn-primary btn-block rounded-2xl h-14 font-bold shadow-lg shadow-primary/10 transition-all">
                        View Details
                      </Link>
                    </div>
                  </div>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-6 pt-4">
                <button 
                  ...
                  disabled={page === 1}
                  className="btn btn-circle btn-primary shadow-lg shadow-primary/20 disabled:opacity-50 disabled:bg-slate-200 disabled:border-slate-200 disabled:text-slate-400"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6"/></svg>
                </button>
                <span className="text-slate-600 font-bold px-4 py-2 bg-slate-100 rounded-2xl">
      ...
      {/* Why Join Section - Images Fixed */}
      <section className="mx-4">
        <div className="bg-slate-900 rounded-[4rem] p-10 md:p-24 text-white overflow-hidden relative">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-slate-400 text-xl leading-relaxed font-medium">
                  Our events are designed to provide students with real-world exposure and a platform to showcase their talents.
                </p>
              </div>
              ...
              <Link to="/login" className="btn btn-secondary btn-lg rounded-2xl px-12 font-bold shadow-2xl shadow-secondary/20">Get Started Now</Link>
            </div>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6">
                  ...
                  <img 
                    src="https://www.babafaridgroup.edu.in/images/Cultural-Activities/9th-MRSPTU-Youth-Fest.jpg" 
                    className="w-full aspect-[3/4] object-cover rounded-[3rem] shadow-2xl transition-transform hover:scale-105 duration-700" 
                    alt="Campus Life" 
                    referrerPolicy="no-referrer" 
                  />
                ...
                <div className="space-y-6 pt-12">
                  ...
                  {/* Fixed Image Height with aspect-ratio */}
                  <img 
                    src="https://www.babafaridgroup.edu.in/images/Cultural-Activities/27.jpg" 
                    className="w-full aspect-[3/4] object-cover rounded-[3rem] shadow-2xl transition-transform hover:scale-105 duration-700" 
                    alt="Campus Life" 
                    referrerPolicy="no-referrer" 
                  />
